...
class HypothesisTest:
    ...
    def kolmogorov_smirnov(
        ...
        return HypothesisTestResult(
            ...
            effect_interpretation="Large" if ks_stat > 0.2 else "Small" if ks_stat > 0.1 else "Negligible",
        )
...
class StatisticalComparison:
    ...
    def __init__(
        ...
        self.bootstrap_ci: Optional[Tuple] = None
    ...
    def print_report(self):
        ...
        for name, stats in summary['groups'].items():
            print(f"  {name}: n={stats['n']}, μ={stats['mean']:.4f}, σ={stats['std']:.4f}")
        ...
        for test_name, test_result in summary['tests'].items():
            ...
            if test_result['effect_size'] is not None:
                print(f"    Effect: {test_result['effect_interpretation']} ({test_result['effect_size']:.3f})")

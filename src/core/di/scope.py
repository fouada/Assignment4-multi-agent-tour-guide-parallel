...
_current_scope: contextvars.ContextVar[Optional[ScopeContext]] = contextvars.ContextVar(
...
class Scope:
    ...
    def resolve(self, service_type: Type[T]) -> T:
        ...
        from src.core.di.container import get_container, Lifetime
    ...
    @classmethod
    def current(cls) -> Optional[ScopeContext]:
        """Get current scope context."""
        return _current_scope.get()
    
    @classmethod
    def get_active(cls, name: str) -> Optional[ScopeContext]:

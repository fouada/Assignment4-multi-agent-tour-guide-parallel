...
class ResultCollector:
    ...
    def add_decision(self, decision: JudgeDecision):
        ...
        with self._lock:
            ...
            point_info = f"Point {point.index}" if point else decision.point_id
    ...
    def get_decision(self, point_id: str) -> Optional[JudgeDecision]:
...
class StreamingCollector(ResultCollector):
    ...
    def __init__(self, route: Route, on_decision: Optional[callable] = None):
        """

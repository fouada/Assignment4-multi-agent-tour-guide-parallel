...
class PluginManager:
    ...
    def start(self, name: str, config: dict[str, Any] | None = None) -> None:
        """
    ...
    def start_all(self) -> dict[str, bool]:
        ...
        logger.info(f"Started {success_count}/{len(results)} plugins successfully")
...
def init_plugins(config: PluginManagerConfig | None = None) -> PluginManager:

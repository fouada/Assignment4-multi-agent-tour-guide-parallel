    ...
    def create_cost_overview_dashboard(
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=daily_costs,
                mode="lines+markers",
                line={"color": COST_COLORS["primary"], "width": 2},
                fill="tozeroy",
        ...
        fig.update_layout(
            ...
            font={"color": COST_COLORS["text"], "size": 11},
            showlegend=False,
            height=700,
            title={
                "text": "💰 Cost Analysis Overview",
                "font": {"size": 20, "color": COST_COLORS["primary"]},
                "x": 0.5,
            },
        )
    ...
    def create_sunburst(
        ...
        fig.update_layout(
            ...
            title={
                ...
                "font": {"size": 18, "color": COST_COLORS["primary"]},
                "x": 0.5,
            },
            height=600,
        )
...
class CostTrendChart:
    ...
    def create_cost_trend_with_forecast(
        ...
        daily_growth = (
            historical_costs["cost"].iloc[-1] - historical_costs["cost"].iloc[-30]
        ) / 30

        forecast_dates = pd.date_range(
            start=last_date, periods=forecast_days + 1, freq="D"
        )[1:]
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="lines",
                name="Forecast",
                line={"color": COST_COLORS["secondary"], "width": 2, "dash": "dash"},
            ),
            row=1,
            col=1,
        )
        ...
        colors = [
            COST_COLORS["savings"] if c < 0 else COST_COLORS["overhead"]
    ...
    def create_cumulative_cost_chart(
        ...
        for i, cat in enumerate(categories):
            cat_data = cost_events[cost_events["category"] == cat].sort_values(
                "timestamp"
            )
...
class ROIChart:
    ...
    def create_roi_comparison(
        ...
        paybacks = [
            r.get("metrics", {}).get("payback_period_months", 0) for r in roi_data
        ]
        ...
        fig.add_trace(
            go.Bar(
                ...
                y=rois,
                marker_color=[
                    COST_COLORS["savings"] if r > 0 else COST_COLORS["overhead"]
                    for r in rois
                ],
    ...
    def create_savings_projection(
        ...
        fig.add_trace(
            go.Scatter(
                ...
                line={"color": COST_COLORS["savings"], "width": 3},
                fill="tozeroy",
                fillcolor="rgba(104, 211, 145, 0.2)",
            )
        )
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="lines",
                name="Net Benefit",
                line={"color": COST_COLORS["primary"], "width": 2, "dash": "dot"},
            )
        )
    ...
    def create_optimization_impact_matrix(
        ...
        efforts = [
            effort_map.get(r.get("implementation", {}).get("effort", "medium"), 2)
            for r in recommendations
        ]
        impacts = [
            r.get("costs", {}).get("savings_percent", 0) for r in recommendations
        ]
        ...
        fig.add_annotation(
            ...
            text="Quick Wins",
            showarrow=False,
            font={"size": 14, "color": COST_COLORS["savings"]},
        )
        ...
        fig.add_annotation(
            ...
            text="Strategic",
            showarrow=False,
            font={"size": 14, "color": COST_COLORS["quaternary"]},
        )
    ...
    def create_kpi_cards(
        ...
        fig.add_trace(
            go.Indicator(
                ...
                delta={"reference": budget * 0.8, "valueformat": ".0f"},
        ...
        fig.add_trace(
            go.Indicator(
                ...
                value=savings,
                number={"prefix": "$", "valueformat": ",.2f"},
                delta={"reference": savings * 0.9, "valueformat": ".0f"},

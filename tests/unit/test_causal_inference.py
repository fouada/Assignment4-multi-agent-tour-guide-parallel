...
class TestStructuralCausalModel:
    ...
    def scm(self):
        ...
        scm.equations[CausalVariable.USER_SATISFACTION] = StructuralEquation(
            variable=CausalVariable.USER_SATISFACTION,
            parents=[CausalVariable.CONTENT_RELEVANCE, CausalVariable.CONTENT_QUALITY, CausalVariable.USER_MOOD],
            coefficients={
...
class TestIntervenedSCM:
    ...
    def test_intervened_sample(self):
        ...
        base_scm.equations[CausalVariable.USER_SATISFACTION] = StructuralEquation(
            variable=CausalVariable.USER_SATISFACTION,
            parents=[CausalVariable.AGENT_SELECTED, CausalVariable.LOCATION_TYPE],
            coefficients={CausalVariable.AGENT_SELECTED: 0.5, CausalVariable.LOCATION_TYPE: 0.3},
            intercept=0.1,
            noise_std=0.1,
        )
        base_scm.topological_order = list(base_scm.exogenous) + [CausalVariable.USER_SATISFACTION]
        
        intervened_scm = IntervenedSCM(
            base_scm, 
...
class TestCausalEffectEstimator:
    ...
    def observations(self):
        ...
        for _ in range(100):
            ...
            satisfaction = 0.3 * agent + 0.2 * loc + 0.1 * age + 0.1 * np.random.random()
...
class TestAgentPerformanceAnalyzer:
    ...
    def analyzer_with_mock_scm(self):
        ...
        analyzer.agent_mapping = {"text": 0.0, "video": 0.33, "audio": 0.66, "image": 1.0}
        return analyzer

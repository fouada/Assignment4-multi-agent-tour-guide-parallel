...
def sample_route():
    ...
    return Route(
        ...
        points=[
            RoutePoint(
                id="p1", index=0, address="Point 1",
                location_name="Loc1", latitude=32.0, longitude=34.0
            ),
            RoutePoint(
                id="p2", index=1, address="Point 2",
                location_name="Loc2", latitude=32.1, longitude=34.1
            ),
            RoutePoint(
                id="p3", index=2, address="Point 3",
                location_name="Loc3", latitude=32.2, longitude=34.2
            ),
        ],
        total_distance=3000,
        total_duration=180
...
class TestScheduledPointEmitter:
    ...
    def test_progress_empty_route(self):
        ...
        empty_route = Route(
            ...
            points=[], total_distance=0, total_duration=0
        )

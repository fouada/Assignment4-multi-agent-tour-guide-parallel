...
class TestResearchVisualizerInit:
    ...
    def test_creates_output_directory(self, tmp_path):
        ...
        viz = ResearchVisualizer(output_dir=output)
...
class TestCompareDistributions:
    ...
    def test_save_figure(self, visualizer_with_output, sample_a, sample_b):
        ...
        fig = visualizer_with_output.compare_distributions(
            sample_a, sample_b,
            save_name="dist_comparison"
        )
...
class TestSensitivityPlot:
    ...
    def test_single_metric(self, visualizer):
        ...
        fig = visualizer.sensitivity_plot(
            param_values, metrics,
            param_name="Timeout (s)"
        )
    ...
    def test_save_sensitivity(self, visualizer_with_output):
        ...
        fig = visualizer_with_output.sensitivity_plot(
            param_values, metrics,
...
class TestEffectSizeForestPlot:
    ...
    def test_save_forest_plot(self, visualizer_with_output):
        ...
        fig = visualizer_with_output.effect_size_forest_plot(
            effects,
            save_name="forest_plot"
        )
...
class TestStatusDistributionPlot:
    ...
    def test_custom_title(self, visualizer):
        ...
        fig = visualizer.status_distribution_plot(
            status_counts,
            title="Custom Status Distribution"
        )
    ...
    def test_save_status_plot(self, visualizer_with_output):
        ...
        fig = visualizer_with_output.status_distribution_plot(
            status_counts,
            save_name="status_dist"
        )
...
class TestHeatmap:
    ...
    def test_save_heatmap(self, visualizer_with_output):
        ...
        fig = visualizer_with_output.heatmap(
            data,
            x_labels=['A', 'B', 'C', 'D'],
            y_labels=['1', '2', '3', '4'],
            save_name="heatmap"
...
class TestEdgeCases:
    ...
    def test_many_comparisons_forest(self, visualizer):
        ...
        effects = {f'Comparison {i}': (i*0.1 - 0.5, i*0.1, i*0.1 + 0.5) 
                   for i in range(15)}

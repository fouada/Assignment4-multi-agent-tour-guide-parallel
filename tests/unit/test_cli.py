...
from src.models.user_profile import UserProfile, AgeGroup
...
class TestMainFunction:
    ...
    def test_main_demo_mode_with_profile(self, mock_demo):
        ...
        with patch('sys.argv', ['main.py', '--demo', '--profile', 'family', '--min-age', '8']):
            result = main()
    ...
    def test_main_exception(self):
        ...
        with patch('sys.argv', ['main.py', '--demo']):
            with patch('src.cli.main.run_demo_pipeline', side_effect=Exception("Test error")):
                result = main()

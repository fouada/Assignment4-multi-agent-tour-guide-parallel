...
class TestBootstrapAnalysis:
    ...
    def test_confidence_interval_reproducible(self, sample_data):
        ...
        result1 = BootstrapAnalysis.confidence_interval(sample_data, seed=42, n_bootstrap=100)
        result2 = BootstrapAnalysis.confidence_interval(sample_data, seed=42, n_bootstrap=100)

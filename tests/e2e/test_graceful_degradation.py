...
from src.models.user_profile import AgeGroup, Gender, UserProfile
...
class TestGracefulDegradation:
    ...
    def test_degradation_quality_penalty(self, test_point, test_profile):
        ...
        # Full results
        full_queue = SmartAgentQueue(point_id="full_test")
        ...
        # Partial results
        partial_queue = SmartAgentQueue(
            point_id="partial_test", soft_timeout=0.1, hard_timeout=0.2
        )
    ...
    def test_partial_results_still_useful(self, test_point, test_profile):
        ...
        judge = JudgeAgent()
        decision = judge.evaluate(test_point, results, test_profile)
